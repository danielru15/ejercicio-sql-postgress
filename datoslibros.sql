...
VALUES  ('Sebastian', 'Zapata', 'sebastian.zapata23', 'sebastian.zapata23@eia.edu.co'),
        ('Juan Jose', 'Giraldo Santuareño', 'juan.giraldo55', 'juan.giraldo55@eia.edu.co'),
        ('Lorenzo', 'Porras', 'lorenzo.porras', 'lorenzo.porras@eia.edu.co'),
        ('Natalia', 'Naranjo', 'natalia.naranjo', 'natalia.naranjo@eia.edu.co'),
		('Wendy', 'Arevalo', 'wendy.arevalo', 'wendy.arevalo@eia.edu.co'),
		('Emmanuel', 'Jaramillo', 'emmanuel.jaramillo', 'emmanuel.jaramillo@eia.edu.co');

INSERT INTO libros_usuarios(libro_id, usuario_id)
VALUES (1, 5), (2, 5), (3, 1), (4, 1), (5, 4), (5, 5),
		(4, 2), (5, 2), (1, 3), (2, 3), (4, 3), (5, 3);